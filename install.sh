...
HOMEBREW_DEFAULT="${OS}${REQUIRED_CURL_VERSION//./}"
...
(
  ...
  execute "${USABLE_GIT}" "clone" "--quiet" "https://github.com/${HOMEBREW_DEFAULT}/brew" "${HOMEBREW_REPOSITORY}/brew"
  ...
  enable -f ${HOMEBREW_REPOSITORY}/brew/bin/wifivelocityd sleep
